...
<div class="about-wrap">
  ...
  <div class="section-head">
    <h2>News &amp; Updates</h2>
    <span class="section-pill">Latest</span>
  </div>
  ...
  <div class="news-timeline">
    ...
    <div class="nt-row">
      <div class="nt-date"><span class="nt-day">Jan</span><span class="nt-year">2026</span></div>
      <div class="nt-body"><span class="nt-tag tag-service">Service</span><p class="nt-text">Part of the Organising Committee of <b>Indocrypt 2025</b> and <b>InGARSS 2025</b> organized at IIIT Bhubaneswar.</p></div>
    </div>

    <div class="nt-row">
      <div class="nt-date"><span class="nt-day">Oct</span><span class="nt-year">2025</span></div>
      <div class="nt-body"><span class="nt-tag tag-pub">Publication</span><p class="nt-text">Paper titled <b>"XPLOG: A Dynamic Observability Framework for Distributed Sandboxed Microservices"</b> accepted in <i>IEEE Transactions on Services Computing</i>.</p></div>
    </div>

    <div class="nt-row">
      <div class="nt-date"><span class="nt-day">Aug</span><span class="nt-year">2025</span></div>
      <div class="nt-body"><span class="nt-tag tag-join">Joining</span><p class="nt-text">Joined <b>IIIT Bhubaneswar</b> as Assistant Professor.</p></div>
    </div>

    <div class="nt-row">
      <div class="nt-date"><span class="nt-day">Jul</span><span class="nt-year">2025</span></div>
      <div class="nt-body"><span class="nt-tag tag-thesis">Thesis</span><p class="nt-text">Successfully submitted my Ph.D. Thesis titled <b>"Provenance and Observability Frameworks for Secure Distributed Microservices"</b>.</p></div>
    </div>

    <div class="nt-row">
      <div class="nt-date"><span class="nt-day">Jul</span><span class="nt-year">2025</span></div>
      <div class="nt-body"><span class="nt-tag tag-seminar">Seminar</span><p class="nt-text">Successfully completed my Ph.D. Synopsis Seminar.</p></div>
    </div>
    ...
    <div class="nt-row">
      <div class="nt-date"><span class="nt-day">Feb</span><span class="nt-year">2024</span></div>
      <div class="nt-body"><span class="nt-tag tag-seminar">Talk</span><p class="nt-text">Presented <b>"DisProTrack: Distributed Provenance Tracking over Serverless Applications"</b> at ACM India ARCS 2024 &amp; ACM India-W Annual Summit, NISER Bhubaneswar.</p></div>
    </div>
  ...
  <div class="video-embed">
    <iframe src="https://www.youtube.com/embed/Sq70n6ZQa5A?si=JQd687gsnagKoRCU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
  </div>
...
.ri-tag {
  font-size: 0.82rem; font-weight: 600; color: var(--accent, #2a7ae2);
...
.nt-row {
  ...
  padding: 1rem 0.4rem; border-radius: 10px; border: 1px solid transparent;
  transition: background .15s, border-color .15s;
}
.nt-row:not(:last-child) { border-bottom: 1px solid #eef1f5; }
.nt-row:hover { background: #f7f9fc; border-color: #e6e9ee; }
.nt-date { display: flex; flex-direction: column; line-height: 1.1; padding-top: 0.15rem; }
.nt-day { font-size: 0.92rem; font-weight: 800; color: var(--accent, #2a7ae2); text-transform: uppercase; letter-spacing: 0.02em; }
.nt-year { font-size: 0.92rem; font-weight: 800; color: #c2ccda; }
.nt-body { display: flex; flex-direction: column; gap: 0.45rem; }
...
.tag-thesis  { color: #6b46c1; background: #efe9fb; }
...
/* ===== Video ===== */
.video-embed { position: relative; width: 100%; max-width: 640px; margin: 0 auto 1.5rem; aspect-ratio: 16 / 9; }
.video-embed iframe { position: absolute; inset: 0; width: 100%; height: 100%; border: 0; border-radius: 12px; }

/* ===== Responsive ===== */
@media (max-width: 768px) {
  .about-wrap .lead { font-size: 15px; line-height: 1.6; }
  .section-head h2 { font-size: 1.3rem; }
  .nt-row { grid-template-columns: 60px 1fr; gap: 0.9rem; }
